...
<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	...
	$gantry->addStyle('//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css', 6);
	//$gantry->addStyle('//netdna.bootstrapcdn.com/bootstrap/3.0.3/css/bootstrap.min.css', 7);
	$gantry->addLess('templates/gantry/less/flatstrap.less', 'flatstrap.css');
	$gantry->addScript('media/jui/js/jquery-migrate.min.js');
	$gantry->addScript('media/jui/js/jquery-noconflict.js');
	$gantry->addScript('media/jui/js/bootstrap.js');
